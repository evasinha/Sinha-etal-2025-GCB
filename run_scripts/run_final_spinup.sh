...
readonly MYDATE_AD=20240318
readonly CASE_NAME="${MYDATE_AD}_${RESOLUTION}_${COMPSET_alias}_fnsp"
...
readonly RUN_REFCASE="${MYDATE_AD}_${RESOLUTION}_${COMPSET_alias}_adsp"
