...
readonly CASE_NAME="${MYDATE}_${RESOLUTION}_${COMPSET_alias}_Set1_4"
...
cat ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Precip|sed 's|global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/Precip|global/cfs/cdirs/e3sm/esinha/inputdata/atm/datm7/AWE-GEN/increase_temp_mean_4|' > tmpfile && mv tmpfile ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Precip
cat ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Solar|sed 's|global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/Solar|global/cfs/cdirs/e3sm/esinha/inputdata/atm/datm7/AWE-GEN/increase_temp_mean_4|' > tmpfile && mv tmpfile ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Solar
cat ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.TPQW|sed 's|global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/TPHWL|global/cfs/cdirs/e3sm/esinha/inputdata/atm/datm7/AWE-GEN/increase_temp_mean_4|' > tmpfile && mv tmpfile ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.TPQW
