...
readonly MYDATE_REST=20230818
readonly CASE_NAME="${MYDATE}_${RESOLUTION}_${COMPSET_alias}_control"
...
readonly START_DATE="1980-01-01"
...
export flanduse=${INPUT_DATA_DIR}/lnd/clm2/surfdata_map/landuse.timeseries_US_Midwest_0.25x0.25_hist_50pfts_simyr1980-2009_c240315.nc
...
cat ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Precip|sed 's|global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/Precip|global/cfs/cdirs/e3sm/esinha/inputdata/atm/datm7/AWE-GEN/AWEGEN_forcing|' > tmpfile && mv tmpfile ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Precip
cat ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Solar|sed 's|global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/Solar|global/cfs/cdirs/e3sm/esinha/inputdata/atm/datm7/AWE-GEN/AWEGEN_forcing|' > tmpfile && mv tmpfile ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.Solar
cat ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.TPQW|sed 's|global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/TPHWL|global/cfs/cdirs/e3sm/esinha/inputdata/atm/datm7/AWE-GEN/AWEGEN_forcing|' > tmpfile && mv tmpfile ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMGSWP3v1.TPQW
